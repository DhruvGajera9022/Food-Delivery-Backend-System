...
// API
router.get("/api/invoice", JWTMiddleware.JWTMiddleware, invoiceController.allInvoices);
router.get("/api/invoice/:id", JWTMiddleware.JWTMiddleware, invoiceController.singleInvoice);
